...
from coraoke.lib.download_manager import DownloadManager
from coraoke.lib.events import EventSystem
from coraoke.lib.ffmpeg import (
    get_ffmpeg_version,
...
from coraoke.lib.network import get_ip
from coraoke.lib.playback_controller import PlaybackController
...
from coraoke.version import __version__ as VERSION
...
class Karaoke:
    ...
    def __init__(
        ...
        download_path: str = "/usr/lib/coraoke/songs",
    ...
    def run(self) -> None:
        ...
        while self.running:
            try:
                ...
                logging.warning("Keyboard interrupt: Exiting coraoke...")
                self.running = False

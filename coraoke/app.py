...
from coraoke import VERSION, karaoke
from coraoke.constants import LANGUAGES
from coraoke.lib.args import parse_coraoke_args
from coraoke.lib.browser import Browser
from coraoke.lib.current_app import get_karaoke_instance
from coraoke.lib.ffmpeg import is_ffmpeg_installed
from coraoke.lib.file_resolver import delete_tmp_dir
...
from coraoke.lib.youtube_dl import upgrade_youtubedl
from coraoke.routes.admin import admin_bp
from coraoke.routes.background_music import background_music_bp
from coraoke.routes.batch_song_renamer import batch_song_renamer_bp
from coraoke.routes.controller import controller_bp
from coraoke.routes.files import files_bp
from coraoke.routes.home import home_bp
from coraoke.routes.images import images_bp
from coraoke.routes.info import info_bp
from coraoke.routes.metadata_api import metadata_bp
from coraoke.routes.now_playing import nowplaying_bp
from coraoke.routes.preferences import preferences_bp
from coraoke.routes.queue import queue_bp
from coraoke.routes.search import search_bp
from coraoke.routes.socket_events import setup_socket_events
from coraoke.routes.splash import splash_bp
from coraoke.routes.stream import stream_bp

_ = flask_babel.gettext

from gevent.pywsgi import WSGIServer

args = parse_coraoke_args()
...
app.config["API_TITLE"] = "Coraoke API"
...
def main() -> None:
    ...
    from coraoke.lib.current_app import broadcast_event
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
        ...
        if sock.connect_ex(("127.0.0.1", port)) == 0:
            logging.error("Port %d is already in use. Is coraoke already running?", port)
            sys.exit(1)

...
from obiraoke.lib.current_app import get_admin_password, get_karaoke_instance, is_admin
from obiraoke.lib.youtube_dl import get_youtubedl_version, upgrade_youtubedl

# coraoke — UI Specification

> **Authoritative style guide for ALL coraoke UI work.**
...
"coraoke v0.1.0"  ← always lowercase
```
...
- Dashboard: `"Canonical coraoke"` + hostname badge
- Docs: `"Docs - Canonical coraoke"`
...
09. **"Canonical coraoke"** in visible UI branding. **"coraoke"** (lowercase)

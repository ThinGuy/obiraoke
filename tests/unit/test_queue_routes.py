...
class TestQueueRoutes:
    ...
    @patch("coreaoke.routes.queue.get_karaoke_instance")
...
class TestQueueEditSocketUpdates:
    ...
    @patch("coreaoke.routes.queue.is_admin", return_value=True)
    @patch("coreaoke.routes.queue.get_karaoke_instance")
    @patch("coreaoke.routes.queue.broadcast_event")
    @patch("coreaoke.routes.queue._", side_effect=lambda x: x)

...
from obiraoke.lib.playback_controller import PlaybackController, PlaybackResult
...
class TestPlaybackControllerPlayFile:
    ...
    @patch("obiraoke.lib.playback_controller.os.path.isfile", return_value=True)
    @patch("obiraoke.lib.playback_controller.time.sleep")
...
class TestPlaybackControllerEndSong:
    ...
    @patch("obiraoke.lib.playback_controller.time.sleep")
    @patch("obiraoke.lib.playback_controller.delete_tmp_dir")

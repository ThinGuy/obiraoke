...
from coreaoke.lib.playback_controller import PlaybackController, PlaybackResult
...
class TestPlaybackControllerPlayFile:
    ...
    @patch("coreaoke.lib.playback_controller.os.path.isfile", return_value=True)
    @patch("coreaoke.lib.playback_controller.time.sleep")
...
class TestPlaybackControllerEndSong:
    ...
    @patch("coreaoke.lib.playback_controller.time.sleep")
    @patch("coreaoke.lib.playback_controller.delete_tmp_dir")

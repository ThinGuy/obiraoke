...
from coraoke.lib.playback_controller import PlaybackController, PlaybackResult
...
class TestPlaybackControllerPlayFile:
    ...
    @patch("coraoke.lib.playback_controller.os.path.isfile", return_value=True)
    @patch("coraoke.lib.playback_controller.time.sleep")
...
class TestPlaybackControllerEndSong:
    ...
    @patch("coraoke.lib.playback_controller.time.sleep")
    @patch("coraoke.lib.playback_controller.delete_tmp_dir")

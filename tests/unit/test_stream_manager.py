...
from coraoke.lib.stream_manager import PlaybackResult, StreamManager, enqueue_output
...
class TestStreamManagerLogFfmpegOutput:
    ...
    def test_log_output_when_queue_has_items(self, test_prefs):
        ...
        with patch("coraoke.lib.stream_manager.logging") as mock_logging:
...
class TestStreamManagerCopyFile:
    ...
    @patch("coraoke.lib.stream_manager.time")
    @patch("coraoke.lib.stream_manager.os.path.exists", return_value=False)
    @patch("coraoke.lib.stream_manager.shutil")
...
class TestStreamManagerTranscodeFile:
    ...
    @patch("coraoke.lib.stream_manager.Thread")
    @patch("coraoke.lib.stream_manager.build_ffmpeg_cmd")
...
class TestStreamManagerPlayFile:
    ...
    @patch("coraoke.lib.stream_manager.FileResolver")
    ...
    @patch("flask_babel._", side_effect=lambda x: x)
    @patch("coraoke.lib.stream_manager.is_transcoding_required", return_value=False)
    @patch("coraoke.lib.stream_manager.FileResolver")
    ...
    @patch("flask_babel._", side_effect=lambda x: x)
    @patch("coraoke.lib.stream_manager.is_transcoding_required", return_value=True)
    @patch("coraoke.lib.stream_manager.FileResolver")

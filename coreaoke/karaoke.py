...
from coreaoke.lib.download_manager import DownloadManager
from coreaoke.lib.events import EventSystem
from coreaoke.lib.ffmpeg import (
    get_ffmpeg_version,
...
from coreaoke.lib.library_scanner import LibraryScanner, ScanResult
from coreaoke.lib.network import get_ip
from coreaoke.lib.playback_controller import PlaybackController
...
from coreaoke.version import __version__ as VERSION
...
class Karaoke:
    ...
    def __init__(
        ...
        download_path: str = "/usr/lib/coreaoke/songs",
        ...
        logging.info("Coreaoke version: " + VERSION)
    ...
    def run(self) -> None:
        ...
        """
        logging.debug("Starting Coreaoke run loop")
        ...
        while self.running:
            try:
                ...
                logging.warning("Keyboard interrupt: Exiting coreaoke...")
                self.running = False

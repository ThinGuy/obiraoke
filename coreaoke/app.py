...
from coreaoke import VERSION, karaoke
from coreaoke.constants import LANGUAGES
from coreaoke.lib.args import parse_coreaoke_args
from coreaoke.lib.browser import Browser
from coreaoke.lib.current_app import get_karaoke_instance
from coreaoke.lib.ffmpeg import is_ffmpeg_installed
from coreaoke.lib.file_resolver import delete_tmp_dir
...
from coreaoke.routes.images import images_bp
from coreaoke.routes.info import info_bp
from coreaoke.routes.metadata_api import metadata_bp
from coreaoke.routes.now_playing import nowplaying_bp
from coreaoke.routes.preferences import preferences_bp
from coreaoke.routes.queue import queue_bp
...
app.config["API_TITLE"] = "Coreaoke API"
...
def main() -> None:
    ...
    from coreaoke.lib.current_app import broadcast_event
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
        ...
        if sock.connect_ex(("127.0.0.1", port)) == 0:
            logging.error("Port %d is already in use. Is coreaoke already running?", port)
            sys.exit(1)

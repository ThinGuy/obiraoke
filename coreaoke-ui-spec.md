# coreaoke — UI Specification

> **Authoritative style guide for ALL coreaoke UI work.**
...
"coreaoke v0.1.0"  ← always lowercase
```
...
- Dashboard: `"Canonical coreaoke"` + hostname badge
- Docs: `"Docs - Canonical coreaoke"`
...
09. **"Canonical coreaoke"** in visible UI branding. **"coreaoke"** (lowercase)
